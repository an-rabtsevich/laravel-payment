...
class StripeService
{
    ...
    public function handleApproval()
    {
        if(session()->has('paymentIntentId'))
        {
            ...
            if($confirmation->status === 'succeeded')
            {
                ...
                return redirect()->route('home')->withSuccess(['payment' => "Thanks. We received your {$amount}{$currency} payment."]);
            }
        }
    ...
    public function handleSubscription(Request $request)
    {
        ...
        return redirect()->route('subscribe.show')->withErrors('We were unable to activate the subscription. Try again, please.');
    }
    ...
    public function validateSubscription(Request $request)
    {
        ...
        {  
            ...
            return $subscriptionId == $request->subscription_id;
        }
